...
class ClinvarIntegrationSpec extends PipelineSpec with Matchers with BeforeAndAfterAll {
  ...
  private val filePatternsAndDescriptions = Set(
    ...
    ("clinical_assertion_observation/*.json",  "have written the correct clinical_assertion_observation data"),
    ("clinical_assertion_trait/*.json", "have written the correct clinical_assertion_trait data"),
    ("clinical_assertion_trait_set/*.json", "have written the correct clinical_assertion_trait_set data"),
    ("clinical_assertion_variation/*.json", "have written the correct clinical_assertion_variation data"),
    ...
    ("variation_archive_release/*.json", "have written the correct variation_archive_release data"),
  )
